...
Here is a definition of some variables used in this file:
...
#--------------------------------------------------------------------------------------------------------------------#
#--(4) Build gradient (d/dx, d/dy) and Spatial average operators for f(x,y) where (x,y) are fault nodes coordinates--# 
#--(in the fault reference frame):-----------------------------------------------------------------------------------#
#--------------------------------------------------------------------------------------------------------------------#
KIS_GRADIENT_FEM.m
    input:
        ./KIS_PARAM.mat (from KIS_PARAMETRISATION.m)
